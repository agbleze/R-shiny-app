...
function(messages){
  ...
  /*delete the dropdown if it already exists which it will the second time this function is called */
  ...
  // add ascending numbers up to the value of the message 
  ...
  // add an onchange function to call shinyRules everytime this input changes
